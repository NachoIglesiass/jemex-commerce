  ...
  const galleryImages = [
    {
      ...
      description: "Extensos campos de soja en el norte argentino durante la hora dorada",
      category: "Cultivos"
    },
    {
      src: workerImage,
      title: "Control de Calidad",
      description: "Inspección profesional de plantas en el campo para garantizar la calidad",
      category: "Proceso"
    },
    {
      src: grainsImage,
    ...
    },
    {
      ...
      description: "Modernas instalaciones de almacenamiento y procesamiento",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div ref={galleryRef as any} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {galleryImages.map((image, index) => (
            <Card 
              key={index} 
              className={`group overflow-hidden hover:shadow-elegant transition-all duration-500 border-secondary/20 hover-lift hover-glow ${
                galleryVisible 
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="font-heading font-semibold text-xl text-primary mb-2 text-shimmer">
                  {image.title}
                </h3>
